...
import { teacherNavigationItems, glassStyles, animationClasses } from "@/config/teacher-constants";
import { TeacherSidebarProps } from "@/lib/teacher-types";
import { 
  ChevronLeft, 
  ChevronRight, 
  LogOut 
...
export default function TeacherSidebar({ isCollapsed, onToggle }: TeacherSidebarProps) {
